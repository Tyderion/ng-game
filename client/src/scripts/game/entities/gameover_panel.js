module.exports = (function(Game) {
    Game.Prefabs.GameoverPanel = GameoverPanel;
    ...
    Game.Prefabs.GameoverPanel.prototype.show = show;
    Game.Prefabs.GameoverPanel.prototype.replay = replay;

    function GameoverPanel(game, parent) {
