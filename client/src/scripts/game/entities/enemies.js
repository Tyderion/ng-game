module.exports = (function(Game) {
    Game.Prefabs.Enemies = Enemies;
    Game.Prefabs.Enemies.prototype = Object.create(Phaser.Group.prototype);
    Game.Prefabs.Enemies.constructor = Game.Prefabs.Enemies;
    Game.Prefabs.Enemies.prototype.update = update;
    Game.Prefabs.Enemies.prototype.reset = reset;
    Game.Prefabs.Enemies.prototype.updateStatus = updateStatus;

    function update() {
        this.callAll('update');
    }

    function reset(from, to, speed) {
        this.exists = true;
    ...
    function updateStatus(enemy, autoKill) {
        this.livingEnemies--;
        if (autoKill) {
    ...
    function Enemies(game, count, enemyDesc, hero, parent) {
