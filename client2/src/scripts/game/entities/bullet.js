module.exports = (function(Game) {
    ...
    function shootFrom(data) {
        ...
        this.xVel = Math.cos(this.rotation) * data.speed;
        this.yVel = Math.sin(this.rotation) *  data.speed;
    }
    ...
    function Bullet(game, x, y, player, handleKilledFn, rotationx, rotationy) {
