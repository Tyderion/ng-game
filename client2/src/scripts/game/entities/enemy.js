module.exports = (function(Game) {
    Game.Prefabs.Enemy = Enemy;

    Game.Prefabs.Enemy.prototype = Object.create(Phaser.Sprite.prototype);
    Game.Prefabs.Enemy.constructor = Game.Prefabs.Enemy;
    Game.Prefabs.Enemy.prototype.update = update;
    Game.Prefabs.Enemy.prototype.die = die;
    Game.Prefabs.Enemy.prototype.pause = pause;
    Game.Prefabs.Enemy.prototype.reload = reload;
    Game.Prefabs.Enemy.prototype.resetTarget = resetTarget;
    ...
    function resetTarget(to) {
        this.target = new Phaser.Point(this.x || this.game.width / 2, to);
    }

    function Enemy(game, x, y, desc, target) {
