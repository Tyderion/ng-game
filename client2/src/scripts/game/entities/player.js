module.exports = function(Game) {
    ...
    Game.Prefabs.Player.prototype.getBulletData = getBulletData;

    var DEFAULT_BULLET_SPEED = 500;

    var defaultBulletData = {
    ...
    //     //TODO: Grab pickups and edit data
         return [defaultBulletData, {
            speed: DEFAULT_BULLET_SPEED,
            rotation: 0,
            position: new Phaser.Point(10, 0)
         }, {
            speed: DEFAULT_BULLET_SPEED,
            rotation: 0,
            position: new Phaser.Point(-10, 0)
